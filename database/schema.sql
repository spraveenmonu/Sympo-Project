...
INSERT INTO submissions (id, mode, name, college, members, score, solved, tier, action, encryption, image_file, timestamp) VALUES ('REC-2026-1707', 'solo', 'Pra', 'Grace', 'Pra', 200, '3/24', '⚡ CODE BREAKER', 'Score Shared (Opened Score Sheet)', 'NONE (Plaintext)', 'database/certificates/REC-2026-1707_Pra.jpg', CURRENT_TIMESTAMP);
INSERT INTO submissions (id, mode, name, college, members, score, solved, tier, action, encryption, image_file, timestamp) VALUES ('REC-2026-3229', 'solo', 'Pra', 'Grace', 'Pra', 200, '3/24', '⚡ CODE BREAKER', 'Score Shared (Opened Score Sheet)', 'NONE (Plaintext)', 'database/certificates/REC-2026-3229_Pra.jpg', CURRENT_TIMESTAMP);
INSERT INTO submissions (id, mode, name, college, members, score, solved, tier, action, encryption, image_file, timestamp) VALUES ('REC-2026-3419', 'solo', 'Pra', 'Grace', 'Pra', 200, '3/24', '⚡ CODE BREAKER', 'Score Shared (Opened Score Sheet)', 'NONE (Plaintext)', 'database/certificates/REC-2026-3419_Pra.jpg', CURRENT_TIMESTAMP);
INSERT INTO submissions (id, mode, name, college, members, score, solved, tier, action, encryption, image_file, timestamp) VALUES ('REC-2026-8779', 'solo', 'Anonymous Hacker', 'Symposium Participant', 'Anonymous Hacker', 50, '1/24', '🔰 CYBER SCOUT', 'Score Shared (Opened Score Sheet)', 'NONE (Plaintext)', 'database/certificates/REC-2026-8779_Anonymous_Hacker.jpg', CURRENT_TIMESTAMP);
INSERT INTO submissions (id, mode, name, college, members, score, solved, tier, action, encryption, image_file, timestamp) VALUES ('REC-2026-2910', 'solo', 'Praxxxxxxx', 'Grace', 'Praxxxxxxx', 50, '1/24', '🔰 CYBER SCOUT', 'Submitted to Program Database', 'NONE (Plaintext)', 'database/certificates/REC-2026-2910_Praxxxxxxx.jpg', CURRENT_TIMESTAMP);
INSERT INTO submissions (id, mode, name, college, members, score, solved, tier, action, encryption, image_file, timestamp) VALUES ('REC-2026-7056', 'solo', 'Test Participant', 'Test College', 'Test Participant', 150, '3/24', 'CYBER SPECIALIST', 'Dispatched to Coordinator WhatsApp', 'NONE (Plaintext)', 'none', CURRENT_TIMESTAMP);